...
To install RTCGAToolbox, you can use Bioconductor. Source code is also available on GitHub.
...
```{r eval=FALSE}
brcaData
brcaClinical = getData(brcaData,"Clinical")
brcaRNAseqCounts = getData(brcaData,"RNASeqGene")
#following function will export data from first platform in the list
brcamRNAArray = getData(brcaData,"mRNAArray",1)
brcaCN = getData(brcaData,"GISTIC")
